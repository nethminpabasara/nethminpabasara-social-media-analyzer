...
export default async function handler(req, res) {
  ...
  try {
    const { handle, bio, recentCaptions, platform } = req.body || {};
    ...
    const safePlatform = ['instagram', 'facebook', 'tiktok'].includes(platform) ? platform : 'instagram';
    ...
    const prompt = `You are a world-class social media strategist. Analyze this ${safePlatform} profile.

Handle: @${handle}
Platform: ${safePlatform}
Bio: ${safeBio}
Recent Post/Video Captions: ${JSON.stringify(safeCaptions)}
